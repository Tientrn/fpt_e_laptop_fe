      ...
      <div className="relative min-h-[85vh] overflow-hidden bg-[#f8f5f2]">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 pt-12 pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              >
                Your<span className="text-[#3d5a80]">.</span>Tech<span className="text-[#ee6c4d]">.</span>
                <span className="block mt-1">Your Future<span className="text-[#ee6c4d]">.</span></span>
              </motion.h1>
              ...
              >
                Access premium laptop solutions through flexible purchase or borrowing options designed specifically for your academic journey.
              </motion.p>
            ...
            >
              ...
              >
                <div className="text-xs text-[#293241]/70 uppercase tracking-wider">Students</div>
              ...
              >
                <div className="text-xs text-[#293241]/70 uppercase tracking-wider">Rating</div>
                <div className="text-xl font-bold text-[#ee6c4d] flex items-center">
                  4.9
                  <svg className="w-4 h-4 ml-1 text-[#ee6c4d]" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
            <path d="M0 100L48 87.5C96 75 192 50 288 45.8C384 41.7 480 58.3 576 62.5C672 66.7 768 58.3 864 54.2C960 50 1056 50 1152 54.2C1248 58.3 1344 66.7 1392 70.8L1440 75V100H1392C1344 100 1248 100 1152 100C1056 100 960 100 864 100C768 100 672 100 576 100C480 100 384 100 288 100C192 100 96 100 48 100H0Z" fill="#ffffff"/>
          </svg>
        </div>
      </div>
        ...
        <div className="container mx-auto relative z-10 max-w-6xl">
          <div className="flex flex-col items-center mb-10">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              We extend our gratitude to these generous individuals who have contributed to our mission
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-4 tracking-tight">
                Premium tech for every <span className="text-[#ee6c4d]">academic need</span>
              </h2>
              <p className="text-[#293241]/70 mb-8">
                Choose the option that best fits your needs, whether you&apos;re looking to purchase a premium laptop or borrow one for the semester.
              </p>
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-3/5 p-6">
                      <h3 className="text-xl font-bold text-[#3d5a80] mb-3">Premium Laptops</h3>
                      <p className="text-[#293241]/70 mb-4">
                        Explore our selection of high-performance laptops available for purchase. All models come with warranty and technical support.
                      </p>
                      <Link 
                        to="/laptopshop" 
                ...
                >
                  <div className="flex flex-col md:flex-row-reverse">
                    ...
                    <div className="md:w-3/5 p-6">
                      <h3 className="text-xl font-bold text-[#3d5a80] mb-3">Laptop Borrowing</h3>
                      <p className="text-[#293241]/70 mb-4">
                        Borrow laptops for your semester needs with flexible timeframes and affordable rates. Perfect for temporary academic projects.
                      </p>
                      <Link 
                        to="/laptopborrow" 
                        className="inline-flex items-center text-[#ee6c4d] font-medium transition-all hover:pl-2"
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col items-center mb-10">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Browse our selection of high-performance laptops curated for students and professionals
            </motion.p>
            
            {/* Borrowing Options */}
            <div className="w-full mb-16">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-[#3d5a80]">Borrowing Options</h3>
                <Link to="/laptopborrow" className="flex items-center text-[#ee6c4d] font-medium hover:underline">
                  View all 
            ...
            <div className="w-full">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-[#3d5a80]">Laptops for Sale</h3>
                <Link to="/laptopshop" className="flex items-center text-[#ee6c4d] font-medium hover:underline">
                  View all 
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Choose from our selection of high-quality laptops tailored for students and professionals.
              Whether buying or borrowing, we&apos;ve got you covered.
            </motion.p>
            <motion.div 
