    ...
    <div className="p-8 bg-white rounded-lg shadow-md">
      ...
      <form className="space-y-6">
        ...
        <div>
          ...
          <div className="w-full p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition-colors duration-200">
        ...
        <button
          type="button"
          onClick={onNext}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-medium transition duration-200 mt-4"
        >
          Tiếp tục
        </button>
      </form>
