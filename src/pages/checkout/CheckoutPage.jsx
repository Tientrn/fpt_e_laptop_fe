...
import { FaArrowLeft, FaShoppingBag, FaLock, FaExclamationTriangle, FaInfoCircle } from "react-icons/fa";
        ...
        if (pendingOrder.orderId.toString() === orderId) {
          ...
          if (pendingOrder.cartHash) {
            ...
            if (currentCartHash !== normalizedSavedHash) {
              setCartChanged(true);
              toast.info("Your cart has changed since this order was created. You may want to create a new order.", {
                autoClose: false
              });
            }
          }
        ...
        {orderExpired && (
          <div className="mb-8 bg-red-50 border border-red-200 rounded-lg p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-600">This order has expired. Please return to cart and create a new order.</p>
            </div>
            <button 
              onClick={handleBackToCart}
        ...
        {cartChanged && !orderExpired && (
          <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-600">Your cart has changed since this order was created. You may want to create a new order with your current cart.</p>
            </div>
            <button 
          ...
          <CheckoutForm
            ...
            shippingCost={shippingCost}
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500">This order has expired. Please create a new order.</p>
                    <button 
                      onClick={handleBackToCart}
