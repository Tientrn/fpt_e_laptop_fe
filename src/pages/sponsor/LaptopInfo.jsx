    ...
    switch(status) {
      case "Approved":
        return {
          ...
          icon: <svg className="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-amber-50 to-white py-3 px-4 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <h2 className="ml-2 text-lg font-bold text-gray-800">Donation Request Details</h2>
            <span className={`${className} ml-auto text-xs px-2.5 py-1 rounded-full font-medium flex items-center`}>
              {icon}
              {label}
            </span>
          </div>
            ...
            <div className="md:w-2/3">
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                <div className="inline-flex items-center bg-gray-50 rounded-lg py-1.5 px-3">
                  ...
                  <span className="text-sm text-gray-700">{formatDate(selectedForm.createdAt)}</span>
                </div>
                ...
                <div className="inline-flex items-center bg-gray-50 rounded-lg py-1.5 px-3">
                  ...
                  <span className="text-sm text-gray-700">{selectedForm.quantity} item(s)</span>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="bg-gray-50 rounded-lg py-2.5 px-3 border border-gray-100">
                  <p className="text-sm text-gray-700 whitespace-pre-line">{selectedForm.itemDescription}</p>
                </div>
              </div>
              
              {selectedForm.status === "Rejected" && selectedForm.rejectionReason && (
                <div>
                  <h4 className="text-xs font-semibold text-gray-500 uppercase mb-2">Rejection Reason</h4>
    ...
    if (filteredForms.length === 0) {
      return (
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">No donation requests match the current filter</p>
              ...
              <div className="p-4 flex-1 flex flex-col">
                <div className="mb-auto">
                  ...
                  <div className="flex items-center text-gray-500 text-xs mb-2">
                    <svg className="w-3.5 h-3.5 mr-1 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  ...
                  <div className="bg-gray-50 rounded-md p-2 mb-3">
                    <p className="text-xs text-gray-700 line-clamp-2">{form.itemDescription}</p>
                  </div>
                </div>
        ...
        <>
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-5">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage your laptop donation requests</p>
            </div>
