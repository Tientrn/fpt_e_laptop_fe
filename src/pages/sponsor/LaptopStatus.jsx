    ...
    <div>
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Track the status of your donated laptops
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <p className="text-sm text-gray-500">
            You haven&apos;t donated any laptops yet.
          </p>
        </div>
      ) : (
                  ...
                  <div className="p-4 md:col-span-3">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                          <span
                            className={`px-2 py-0.5 rounded-full text-xs ${conditionBadge.class} inline-flex items-center`}
                          >
                            <span className="mr-1">{conditionBadge.icon}</span>{" "}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-3 bg-gray-50 rounded-md mb-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs font-medium text-gray-800">
                          {laptop.screenSize ? `${laptop.screenSize}"` : "N/A"}
                        </span>
                      </div>
                    ...
                    <div className="flex justify-end">
                      <button
                        onClick={() => toggleDetail(laptop.itemId)}
                        className="inline-flex items-center px-3 py-1.5 bg-amber-600 text-white rounded-md text-xs font-medium hover:bg-amber-700 transition-colors duration-200"
                      >
                        {expandedId === laptop.itemId
                          ? "Hide Details"
                          : "View Details"}
                        <svg
                    ...
                    {expandedId === laptop.itemId && (
                      <div className="mt-4 border-t pt-4 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-700">
                        <div>
                          <strong>Model:</strong> {laptop.model || "N/A"}
                        </div>
                        <div>
                          <strong>Color:</strong> {laptop.color || "N/A"}
                        </div>
                        <div>
                        ...
                        <div>
                          <strong>Battery:</strong> {laptop.battery || "N/A"}
                        </div>
                        <div>
                          <strong>Ports:</strong> {laptop.ports || "N/A"}
                        </div>
                        <div>
                          <strong>Production Year:</strong>{" "}
                          {laptop.productionYear || "N/A"}
                        </div>
                        <div>
                          <strong>Operating System:</strong>{" "}
                          {laptop.operatingSystem || "N/A"}
                        </div>
                        <div>
                          <strong>Description:</strong>{" "}
                          {laptop.description || "N/A"}
                        </div>
                      </div>
                    )}
                  </div>
