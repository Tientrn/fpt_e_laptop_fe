      ...
      >
        ...
        <div className="flex items-center h-20 bg-gradient-to-r from-indigo-900 via-indigo-800 to-purple-900 px-6">
          ...
          <div className="ml-3 flex items-center">
            ...
            <div className="ml-3">
              <h2 className="text-xl font-bold text-white leading-tight">Student</h2>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3 flex-1 overflow-hidden">
              <p className="text-sm font-medium text-gray-800 truncate">
                {userData?.fullName || "Student Account"}
              </p>
              <p className="text-xs text-gray-500 truncate">{userData?.email || "student@fpt.edu.vn"}</p>
        ...
        <nav className="flex-1 px-3 py-5 space-y-1.5 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          <Link
            ...
            className={`
              ...
              ${isPathActive("/student/profile") 
                ? "bg-gradient-to-r from-indigo-700 to-purple-700 text-white shadow-md" 
                : "text-gray-700 hover:bg-indigo-50 hover:text-indigo-600"
              }
            `}
          >
            <FaUser className={`w-5 h-5 mr-3 group-hover:scale-110 transition-transform ${!isPathActive("/student/profile") && "text-indigo-600"}`} />
          ...
          <Link
            ...
            className={`
              flex items-center px-4 py-3 rounded-xl
              transition-all duration-200 group
              ${isPathActive("/student/orders") 
                ? "bg-gradient-to-r from-indigo-700 to-purple-700 text-white shadow-md" 
                : "text-gray-700 hover:bg-indigo-50 hover:text-indigo-600"
              }
            `}
          >
            <FaShoppingBag className={`w-5 h-5 mr-3 group-hover:scale-110 transition-transform ${!isPathActive("/student/orders") && "text-indigo-600"}`} />
